...
\begin{frame}{Inspirasjon fra Biologien}
    Dyplæring (Deep Learning) er basert på kunstige nevrale nettverk (ANN).
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Dette lar nettverket lære hierarkiske representasjoner (kanter $\rightarrow$ former $\rightarrow$ objekter).
        \end{itemize}
    \end{columns}
\end{frame}
...
\begin{frame}{Byggeklossene i et CNN}
    \begin{enumerate}
        ...
        Til slutt flates feature-mappen ut til en vektor og sendes gjennom et klassisk nettverk for å gjøre selve klassifiseringen.
    \end{enumerate}
\end{frame}
...
\begin{frame}{Oppsummering}
    \begin{itemize}
        \item Dyplæring, og spesielt CNN, har revolusjonert bildeanalyse.
