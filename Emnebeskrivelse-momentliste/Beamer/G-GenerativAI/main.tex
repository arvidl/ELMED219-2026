...
\subtitle{ELMED219: Momentliste G01--G20}
\author{ELMED219}
\date{Vår 2026}
...
\begin{frame}{G15: Fra \href{https://en.wikipedia.org/wiki/Prompt_engineering}{Prompt Engineering} til \href{https://www.anthropic.com/research/building-effective-agents}{Context Engineering}}
    ...
    \begin{tabular}{lll}
        \toprule
        \textbf{Komponent} & \textbf{Beskrivelse} & \textbf{Medisinsk eksempel} \\
        \midrule
    ...
    \normalsize
    \vspace{0.15cm}
    \begin{block}{\footnotesize Hvorfor viktig i medisin?}
...
\begin{frame}{G18: Håndtere usikkerhet og hallusinasjonsrisiko}
    ...
    \vspace{0.2cm}
    \begin{block}{\footnotesize Anti-hallusinasjons prompt (GPT-5.2 stil)}
        \scriptsize
        ...
        \texttt{- Ved usikkerhet: Eskalér til høyere hastegrad} \\
        \texttt{</usikkerhet\_og\_tvetydighet>}
    \end{block}
    ...
    \normalsize
    \begin{alertblock}{\footnotesize Huskeregel}
        \footnotesize AI = beslutningsstøtte, \textbf{ikke} beslutningstaker. Alltid klinisk validering!
    \end{alertblock}
\end{frame}
...
\begin{frame}{G19--G20: Strukturert ekstraksjon og modellsammenligning}
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \footnotesize
            \begin{enumerate}
                \item Test samme prompt på 2--3 modeller
                \item Sammenlign mot evalueringskriterier
...
\begin{frame}{Oppsummering: Generativ AI og LLM}
    ...
    \begin{itemize}
        ...
        \item G12--G14: Modeller (GPT-5.2, Claude, Gemini), RAG
    \end{itemize}
