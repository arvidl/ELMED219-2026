    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \begin{itemize}
                ...
                \item \href{https://arxiv.org/abs/1910.10683}{T5}, BART
            \end{itemize}
        \end{column}
...
\begin{frame}{G04: Forklare hva \href{https://en.wikipedia.org/wiki/Lexical_analysis\#Token}{tokens} er og hvordan \href{https://en.wikipedia.org/wiki/Tokenization_(lexical_analysis)}{tokenisering} fungerer}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{\href{https://en.wikipedia.org/wiki/Byte_pair_encoding}{Byte Pair Encoding (BPE)}:}
            \begin{itemize}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \begin{block}{\footnotesize Zero-shot prompts}
                \scriptsize
                \texttt{Klassifiser symptom som akutt/kronisk:} \\
                \texttt{``Hodepine i 3 måneder.''} \\[3pt]
                \texttt{Oppsummer denne journalnotaten i 3 setninger.} \\[3pt]
                \texttt{Oversett til pasientvennlig språk:} \\
                \texttt{``Bilateral pneumoni med hypoksemi.''}
            \end{block}
        ...
        \begin{column}{0.42\textwidth}
            \begin{alertblock}{\footnotesize Begrensninger}
                \footnotesize
                For spesialiserte oppgaver kan zero-shot gi dårlige resultater. Da trengs \textbf{few-shot} eksempler.
            \end{alertblock}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{G12: Kjenne til GPT-5, Claude, Gemini og deres anvendelser}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            ...
            \footnotesize
            \begin{itemize}
                \item \textbf{Journaloppsummering} -- Nøkkelinformasjon
                \item \textbf{Litteratursøk} -- Relevante artikler
                \item \textbf{Differensialdiagnostikk} -- Klinisk støtte
            \end{itemize}
        \end{column}
        \begin{column}{0.42\textwidth}
            ...
            \begin{itemize}
                ...
                \item Destillering, kvantisering
                \item GDPR-vennlig, offline
            \end{itemize}
        \end{column}
    \end{columns}

    \begin{block}{\footnotesize \href{https://chat.uib.no/}{chat.uib.no}}
        \footnotesize UiB har egen AI-tjeneste med GDPR-hensyn for studenter og ansatte.
    \end{block}
\end{frame}
