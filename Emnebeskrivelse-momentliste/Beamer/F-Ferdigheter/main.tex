...
\subtitle{ELMED219: Momentliste F01--F14}
\author{ELMED219}
\date{Vår 2026}
...
\begin{frame}{F11: Komponere effektive prompts for medisinske oppgaver}
    ...
    \begin{enumerate}
        \item \textbf{System prompt:} Rolle og grunnleggende instruksjoner
    ...
    \begin{block}{\footnotesize Medisinsk betydning}
        \footnotesize Rik kontekst = mer relevante, personaliserte og trygge AI-svar
    \end{block}
\end{frame}

\begin{frame}{F12: Anvende context engineering i praksis}
    \textbf{Eksempel: Enkel prompt vs. rik kontekst}
    ...
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            \begin{alertblock}{\footnotesize Enkel prompt}
                \scriptsize
                \texttt{Hva er behandlingen for hjertesvikt?}
        ...
        \begin{column}{0.52\textwidth}
            \begin{block}{\footnotesize Rik kontekst}
                \scriptsize
                \texttt{System: Klinisk beslutningsstøtte} \\
...
\begin{frame}{F13: Velge riktig LLM-modell for oppgaven}
    ...
    \vspace{0.2cm}
    \normalsize
    \begin{block}{\footnotesize Praktisk anbefaling}
        \footnotesize For kritiske oppgaver: Test på flere modeller og sammenlign output
    \end{block}
\end{frame}

\begin{frame}{F14: Sammenligne output fra ulike LLM-er}
    \textbf{Evalueringskriterier for medisinsk LLM-output:}
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{enumerate}
                \item \textbf{Medisinsk nøyaktighet} \\
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{enumerate}
                ...
                \item Send samme prompt til 2--3 modeller
                \item Vurder mot kriteriene (1--5 skala)
