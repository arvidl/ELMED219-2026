...
02a/b & Løsninger/utvidet & Løsninger og avanserte teknikker \\
...
Lab 2 utforsker dyplæring med fokus på nevrale nettverk, CNN og medisinsk bildeanalyse. Notebooks er organisert i \textbf{6 deler (A--F)} med tydelig prioritering.

\begin{table}[htbp]
\centering
\caption{Notebooks i Lab 2 -- Del A og B (prioritert)}
\label{tab:lab2ab}
\begin{tabular}{@{}cclp{5.5cm}@{}}
\toprule
\textbf{Del} & \textbf{Pri} & \textbf{Notebook} & \textbf{Innhold} \\
\midrule
A & 1 & A1-CNN-intro & Konseptuell intro til CNN \\
A & 3 & A2-PyTorch-Lightning & Introduksjon til PyTorch og Lightning \\
A & 3 & A3-MNIST-datasamling & Datainnsamling og organisering \\
A & 3 & A4-MNIST-Random-Forest & ML baseline med Random Forest \\
A & 1 & A5-MNIST-MLP & Din første DL-modell (MLP) \\
A & 1 & A6-MNIST-CNN & MNIST med CNN \\
\midrule
B & 1 & B1-nn-intro & Biologiske vs. kunstige nevroner \\
B & 1 & B2-læring-i-nn & Backpropagation, gradient descent \\
B & 1 & B3-hjertesykdom & Klassifisering fra tabelldata \\
B & 1 & B4-EKG-arytmi-CNN & CNN på EKG-signaler \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Notebooks i Lab 2 -- Del C--F (prioritert)}
\label{tab:lab2cf}
\begin{tabular}{@{}cclp{5.5cm}@{}}
\toprule
\textbf{Del} & \textbf{Pri} & \textbf{Notebook} & \textbf{Innhold} \\
\midrule
C & 2 & C1-cnn-miljø-arkitektur & Miljøoppsett og CNN-arkitektur \\
C & 2 & C2-cnn-trening & Trening og lagring av modell \\
C & 2 & C3-cnn-testing-gradcam & Testing, evaluering og Grad-CAM \\
C & 2 & C4-cnn-konklusjon & Oppsummering og veien videre \\
\midrule
D & 2 & D1-MR-demens & MRI-bildeanalyse for demensdeteksjon \\
\midrule
E & 3 & E1-emosjoner-bygging & Emosjonsklassifikasjon (bygging) \\
E & 3 & E2-emosjoner-trening & Emosjonsklassifikasjon (trening) \\
E & 3 & E3-emosjoner-evaluering & Emosjonsklassifikasjon (evaluering) \\
\midrule
F & 4 & F1-TabPFN-intro & Utforskning av TabPFN \\
F & 4 & F2-TabPFN-neuro & TabPFN i nevrovitenskap \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Prioritetsnivåer:} 1 = kjerne (4--5 timer), 2 = anbefalt (3--4 timer), 3 = valgfri (2--3 timer), 4 = avansert (1--2 timer)
...
Teamprosjektet er en sentral del av kurset der studenter i tverrfaglige grupper utarbeider en forskningsplan (søknadsskisse) for et tenkt prosjekt om AI og avbildning ved hjernesvulst. I 2026 har vi \textbf{5 tverrfaglige team} med blanding av studenter fra ELMED219 (medisinstudenter) og BMED365 (masterstudenter i biomedisin).
...
\begin{enumerate}[nosep]
    ...
    \item \textbf{Grafteori og pasient-likhetsnettverk} (valgfri alternativ tilnærming)
    \item Datahåndteringsplan og etiske betraktninger
\end{enumerate}

\begin{infobox}[Metodologiske tilnærminger]
Studenter kan velge mellom eller kombinere:
\begin{itemize}[nosep]
    \item \textbf{Dyplæringsmetoder}: CNN-basert segmentering (nnU-Net, MONAI), klassifisering
    \item \textbf{Pasient-likhetsnettverk (PSN)}: Nettverksbasert pasientstratifisering og subgruppeidentifikasjon (se Lab 1)
    \item \textbf{Nevrosymbolsk AI}: Integrasjon av MRI-analyse med WHO 2021 CNS-klassifikasjon (se Notebook 08 i Lab 3)
\end{itemize}
Denne fleksibiliteten reflekterer virkelig tverrfaglig forskning der ulike metodologier kan kombineres.
\end{infobox}
...
NetworkX & Bibliotek & Nettverksanalyse og PSN (Lab 1) \\
...
nnU-Net & Rammeverk & Medisinsk bildesegmentering (Teamprosjekt) \\
MONAI & Rammeverk & Medisinsk AI med PyTorch (Teamprosjekt) \\
\bottomrule
\end{tabular}
\end{table}
...
NotebookLM & Gratis (Google) & Dokumentanalyse og kunnskapssammenstilling \\
chat.uib.no & UiB-innlogging & UiB-intern AI-tjeneste \\
Cursor AI & Gratis/Pro & AI-assistert kodeeditor \\
...
\textbf{Nyere artikler (2024--2025):}
\begin{itemize}[nosep]
    \item \citet{ghadimi2025deep}: CNN, transformers og hybridarkitekturer for gliom-segmentering
    \item \citet{booth2025review}: Dyplæring for hjernesvulstanalyse i MRI
    \item \citet{ma2024medsam}: MedSAM -- grunnlagsmodell for medisinsk bildesegmentering
\end{itemize}
